...
void commentAction(string pVersion) {
   ...
   comment += "ShortEntry: " + TimeToString(t3HighestHighDateTime) + " - " + DoubleToString(t3ShortEntryValue, 2) + "\n";
   comment += "\n";
   comment += "LONG: " + "\n";
   ...
   comment += "LongEntry: " + TimeToString(t3LowestLowDateTime) + " - " + DoubleToString(t3LongEntryValue, 2) + "\n";
   comment += "\n";
