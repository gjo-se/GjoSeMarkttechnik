...
void setT4Action() {
   ...
   if(t4trendDirection == TREND_DIRECTION_LONG) {
     if(t4LowestLowValue >= t4MinHighVolumeAreaLevel && t4LowestLowValue <= t4MaxHighVolumeAreaLevel) {
         ...
         t4LowestLowIsInSignalArea = false;
            ...
            if(t4LowestLowValue != 0 && t4MinHighVolumeAreaLevel !=0 && t4LowestLowValue < t4MinHighVolumeAreaLevel) {
   ...
   if(t4trendDirection == TREND_DIRECTION_SHORT) {
         ...
         if(t4HighestHighValue != 0 && t4MaxHighVolumeAreaLevel != 0 && t4HighestHighValue > t4MaxHighVolumeAreaLevel) {
