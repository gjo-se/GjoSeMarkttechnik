...
void createT2RegressionChannelLevels() {
   ...
   int thinLineWidth = 1;
   int  visbility = OBJ_PERIOD_D1|OBJ_PERIOD_H1|OBJ_PERIOD_M10;
   ...
   if(t2p1DateTime != 0 && t2p3DateTime != 0) {
      ...
      ObjectSetInteger(ChartID(), T2_REGRESSION_CHANNEL + "0", OBJPROP_TIMEFRAMES, visbility);
      ...
      ObjectSetInteger(ChartID(), T2_REGRESSION_CHANNEL + "100", OBJPROP_TIMEFRAMES, visbility);
      ...
      ObjectSetInteger(ChartID(), T2_REGRESSION_CHANNEL + "25", OBJPROP_TIMEFRAMES, visbility);
      ...
      ObjectSetInteger(ChartID(), T2_REGRESSION_CHANNEL + "50", OBJPROP_TIMEFRAMES, visbility);
      ...
      ObjectSetInteger(ChartID(), T2_REGRESSION_CHANNEL + "75", OBJPROP_TIMEFRAMES, visbility);
   }else{
