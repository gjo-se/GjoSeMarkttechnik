...
void createT2RegressionChannel() {
   ...
   (t2StartDateTime != 0) ? startDateTime = t2StartDateTime : startDateTime = t2p1DateTime;
   datetime endDateTime;
   (t2EndDateTime != 0) ? endDateTime = t2EndDateTime : (endDateTime = iTime(Symbol(), PERIOD_CURRENT, InpT2ChannelEndShift));

   createRegressionChannel(T2_REGRESSION_CHANNEL, startDateTime, endDateTime, InpT2InvisibleColor, isFilled, InpT2LineStyle, InpT2LineWidth);
