...
void createTT4RegressionChannel() {
    ...
    if(tt4p1DateTime != 0 && tt4p6DateTime != 0 ){
        createRegressionChannel(TT4_REGRESSION_CHANNEL, tt4p1DateTime, tt4p6DateTime, InpT3DefaultColor, isFilled, InpT3LineStyle, InpT3LineWidth);
        ObjectSetInteger(ChartID(), TT4_REGRESSION_CHANNEL, OBJPROP_TIMEFRAMES, InpT3VisibleTimeframes);
    }
}